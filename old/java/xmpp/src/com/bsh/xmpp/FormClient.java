...
import com.bsh.xmpp.util.TimeRender;
import com.bsh.xmpp.util.XmppTool;
...
public class FormClient extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		final Chat newchat = cm.createChat("super@211.88.253.7", null);
			...
			public void chatCreated(Chat chat, boolean able) {
				chat.addMessageListener(new MessageListener() {
					...
					public void processMessage(Chat chat2, Message message) {
						...
						if(message.getFrom().contains("super@211.88.253.7")){
							String[] args = new String[] { "super", message.getBody(), TimeRender.getDate(), "IN" };
	...
	private void sendFile(String filepath) {
		...
		final OutgoingFileTransfer fileTransfer = fileTransferManager.createOutgoingFileTransfer("admin@211.88.253.7/Spark 2.6.3");				
